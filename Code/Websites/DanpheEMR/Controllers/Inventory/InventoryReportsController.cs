...
using DanpheEMR.Services.Inventory.DTO.InventoryReports;
...
namespace DanpheEMR.Controllers.Reporting
{
    public class InventoryReportsController : Controller
    {
        ...
        {
            DanpheHTTPResponse<List<INV_RPT_InventorySummaryReport_DTO>> responseData = new DanpheHTTPResponse<List<INV_RPT_InventorySummaryReport_DTO>>();
            try
            {
                InventoryReportingDbContext invreportingDbContext = new InventoryReportingDbContext(connString);
        ...
        {
            DanpheHTTPResponse<ConsumableStockLedgerDetailFinalViewModel> responseData = new DanpheHTTPResponse<ConsumableStockLedgerDetailFinalViewModel>();
            try
            {
                InventoryReportingDbContext invreportingDbContext = new InventoryReportingDbContext(connString);
        ...
        {
            DanpheHTTPResponse<CapitalStockLedgerDetailFinalViewModel> responseData = new DanpheHTTPResponse<CapitalStockLedgerDetailFinalViewModel>();
            try
            {
                InventoryReportingDbContext invreportingDbContext = new InventoryReportingDbContext(connString);
        ...
        {
            DanpheHTTPResponse<List<IssuedItemViewModel>> responseData = new DanpheHTTPResponse<List<IssuedItemViewModel>>();
            try
            {
                InventoryReportingDbContext invreportingDbContext = new InventoryReportingDbContext(connString);
        ...
        {
            DanpheHTTPResponse<ExpirableStockReportFinalViewModel> responseData = new DanpheHTTPResponse<ExpirableStockReportFinalViewModel>();
            try
            {
                InventoryReportingDbContext invreportingDbContext = new InventoryReportingDbContext(connString);
