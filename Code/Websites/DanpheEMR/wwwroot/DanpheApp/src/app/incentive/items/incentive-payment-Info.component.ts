...
export class INCTV_BIL_IncentivePaymentInfoComponent {
  ...
  public summary = {
    ...
    tot_PerformerBilAmt: 0, tot_PerformerInctvAmt: 0, tot_PerformerTDSAmt: 0, tot_PerformerNetPayable: 0,
  ...
  LoadDocItemSummary() {
    ...
    if (this.IsDateValid) {
      ...
      if (this.employeeId && this.employeeId != 0) {
            ...
            if (res.Status == "OK") {
              ...
              if (data && data.Table1 && data.Table1[0]) {
                ...
                if (this.allReportData.length == 0) {
                  this.msgBoxServ.showMessage("notice-message", ['Doctor payment is already made for Selected Date.']);
                }
                this.Initialize();
        ...
        this.msgBoxServ.showMessage("notice-message", ['Select Doctor for the payment']);
      }
    }
    else {
  ...
  public CalculateSummaryAmounts(data) {
    ...
    this.summary.tot_PreviousAdjAmt = 0;
    ...
    this.summary.tot_PerformerBilAmt = this.summary.tot_PerformerInctvAmt = this.summary.tot_PerformerTDSAmt = this.summary.tot_PerformerNetPayable = 0;
    ...
    data.forEach(a => {
      ...
      if (a.IncomeType == 'performer') {
        this.summary.tot_PerformerBilAmt += a.TotalAmount;
        this.summary.tot_PerformerInctvAmt += a.IncentiveAmount;
        this.summary.tot_PerformerTDSAmt += a.TDSAmount;
        this.summary.tot_PerformerNetPayable += a.NetPayableAmt;
      }
    ...
    this.summary.tot_PerformerBilAmt = CommonFunctions.parseAmount(this.summary.tot_PerformerBilAmt);
    this.summary.tot_PerformerInctvAmt = CommonFunctions.parseAmount(this.summary.tot_PerformerInctvAmt);
    this.summary.tot_PerformerTDSAmt = CommonFunctions.parseAmount(this.summary.tot_PerformerTDSAmt);
    this.summary.tot_PerformerNetPayable = CommonFunctions.parseAmount(this.summary.tot_PerformerNetPayable);
    ...
    this.summary.tot_InctvAmt = this.summary.tot_PerformerInctvAmt + this.summary.tot_PrescInctvAmt + this.summary.tot_AdjInctvAmt + this.summary.tot_RefInctvAmt;
    this.summary.tot_NetPayable =  this.summary.tot_PerformerNetPayable + this.summary.tot_PrescNetPayable + this.summary.tot_AdjNetPayable + this.summary.tot_RefNetPayable;
    ...
    this.summary.tot_TDSAmt = this.summary.tot_PerformerTDSAmt + this.summary.tot_PrescTDSAmt + this.summary.tot_AdjTDSAmt + this.summary.tot_RefTDSAmt;
  ...
  public MakePayment() {
    ...
    this.PaymentInfoDetail.TDSAmount = CommonFunctions.parseAmount(this.summary.tot_PrescTDSAmt + this.summary.tot_PerformerTDSAmt);
    this.PaymentInfoDetail.NetPayAmount = CommonFunctions.parseAmount(this.summary.tot_PerformerNetPayable + this.summary.tot_PrescNetPayable);
