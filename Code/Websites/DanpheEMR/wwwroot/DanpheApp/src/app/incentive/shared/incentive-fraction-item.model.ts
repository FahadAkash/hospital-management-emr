...
export class IncentiveFractionItemsModel {
  ...
  public IncentiveType: string = 'performer';
  public IncentiveReceiverId: number = null;
  public IncentiveReceiverName: string = null;
  public FinalIncentivePercent: number = 0;//need to set to zero by default
  ...
  public InitialIncentivePercent: number = 0;

  public BillReturnItemId: number = null;//sud,Krishna:23Feb'22--For multiple invoice item return handling
