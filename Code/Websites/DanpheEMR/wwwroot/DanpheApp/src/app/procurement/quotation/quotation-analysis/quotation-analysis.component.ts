...
export class QuotationAnalysisComponent implements OnInit {
  ...
  issuedDate: string = '';
  constructor(public coreservice: CoreService, public QuotationBLService: QuotationBLService, public messageBoxService: MessageboxService, public inventoryService: InventoryService, public router: Router, public location: Location) {
        ...
        .subscribe(res => {
          if (res.Status == "OK") {
            if (res.Results.vendorList.length) {
              ...
              this.messageBoxService.showMessage("notice", ['Please Add Vendor Quotation before Quatation Analysis.']);
