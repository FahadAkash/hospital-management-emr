...
export class BillingTransactionItem {
  ...
  public PerformerId: number = null;// Krishna,14thjun'22, ProviderId is changed to PerformerId.
  public PerformerName: string = null; // Krishna,14thjun'22, ProviderName is changed to PerformerName.
  public ServiceDepartmentId: number = 0;
  public ServiceDepartmentName: string = null;
  public ServiceItemId: number = 0;//Sud:17Mar'23--For New BillingStructure
  public IntegrationItemId: number = 0;//Sud:17Mar'23--For New BillingStructure
  public ItemCode: string = null;//Sud:17Mar'23--For New BillingStructure
  ...
  public PrescriberName: string = null;// Krishna, 14thjun'22, RequestedByName is changed to PrescriberName.
  ...
  public IsvalidSelPerformerDr: boolean = true; // Krishna, 14thjun'22, changed IsValidSelAssignedToDr to IsvalidSelPerformerDr
  public IsValidSelPrescriberDr: boolean = true; // Krishna, 14thjun'22, changed IsValidSelRequestedByDr to IsValidSelPrescriberDr
  ...
  public PriceCategoryId: number = 1;//this shouldn't be hardcoded.. check another way to assign this.
  ...
  public DiscountSchemeId: number = 0; //Yubraj 30th July '19
  ...
  public ReferredById: number = null; // Krishna, 14thjun'22, Added ReferredBy to track external referral only....
  public IsPriceChangeAllowed = false; //Krishna, 2ndNov'22
  public IsCoPayment = false; //Krishna: 8thDec'22
  public CoPaymentCashAmount: number = 0; //Krishna: 8thDec'22
  public CoPaymentCreditAmount: number = 0; //Krishna: 8thDec'22
  public CoPaymentCashPercent: number = 0; //Krishna: 9thDec'22
  public CoPaymentCreditPercent: number = 0; //Krishna: 9thDec'22
  ...
  constructor() {
    ...
    this.BillingTransactionItemValidator = _formBuilder.group({
      ...
      'PrescriberId': ['', Validators.compose([Validators.required])],
