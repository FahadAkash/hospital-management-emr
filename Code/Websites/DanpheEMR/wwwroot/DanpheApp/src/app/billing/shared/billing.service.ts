...
import { BillItemsPriceCategoryMap } from '../../settings-new/shared/bil-item-price-category-map-model';
...
export class BillingService {
  ...
  public SetBilCfgItemsVsPriceCategoryMapping(billItems: Array<BillItemsPriceCategoryMap>) {
    this.BillItemsVsPriceCategoryMapping = billItems;
  }


  public BillingServiceContextChangedEvent = new Subject<string>();
  public ObserveServiceContextChanged = this.BillingServiceContextChangedEvent.asObservable();
  public TriggerBillingServiceContextEvent(newServiceContext: string) {
    this.BillingServiceContextChangedEvent.next(newServiceContext);
  }
}
