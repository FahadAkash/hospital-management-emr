export class ConsultationRequestGridDTO {
    ...
    public RequestingConsultantName: string = null;
    ...
    public ConsultingDoctorName: string = null;
    public ConsultingDepartmentId: number = null;
    public ConsultingDepartmentName: string = null;
