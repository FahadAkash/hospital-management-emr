...
export class GoodsReceiptVerifyComponent implements OnInit, OnDestroy {
  ...
  public GoodsReceiptVM: InventoryGoodsReceiptVM = new InventoryGoodsReceiptVM();
...
export class InventoryGoodsReceiptVM {
  ...
  public ReceivingUser: VerificationActor = new VerificationActor();
  public Verifiers: Array<VerificationActor>;
  public OrderDetails: VER_PODetailModel = new VER_PODetailModel();
...
export class GRChargesViewModel {
  public Id: number;
