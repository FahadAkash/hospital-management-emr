...
export class PhrmRackEndPoint {
    ...
    public AddRackItem(LatestRack) {
        return this.http.post<any>("/api/Rack/PHRM_MAP_ItemToRack", LatestRack,this.options);
    }
    ...
    public GetDrugList(rackId,StoreId) {
        return this.http.get<any>(`/api/GetDrugsList/${rackId}/${StoreId}`, this.options);
    } 
    public GetAllRack() {
