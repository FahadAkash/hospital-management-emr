...
@Component({
  ...
  templateUrl: "./gov-ins-update-item-price.html"
})

export class GovInsuranceUpdateItemPriceComponent implements OnInit {
  @Output("close-popup")
  ...
  public performerList: any; // Krishna, 16th,jun'22, changed providerList to performerList.
