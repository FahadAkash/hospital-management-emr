...
export class GovInsuranceVisitInfoComponent implements OnInit {
  @Input("visit")
  ...
  ngOnInit() {
    if (this.insuranceService.appointmentType.toLowerCase() == "transfer") {
      ...
      this.visit.PrescriberId = this.insuranceService.ParentVisitInfo.PerformerId;
    }
    else if (this.insuranceService.appointmentType.toLowerCase() == "referral") {
      this.visit.ParentVisitId = this.insuranceService.ParentVisitInfo.PatientVisitId;
      this.visit.ReferredById = this.insuranceService.ParentVisitInfo.PerformerId;
    }
      ...
      this.visit.PerformerId = this.insuranceService.ParentVisitInfo.PerformerId;
      ...
      if (this.insuranceService.ParentVisitInfo.PerformerId) {
        this.selectedDoctor.PerformerName = this.insuranceService.ParentVisitInfo.PerformerName;
        this.selectedDoctor.PerformerId = this.insuranceService.ParentVisitInfo.PerformerId;
      }
    }
