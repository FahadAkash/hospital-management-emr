...
@Component({
  templateUrl: "./gov-ins-patient-list.component.html",
  host: { '(window:keydown)': 'KeysPressed($event)' }
})

export class GovINSPatientListComponent {
  ...
  public PatInsDetails: GovInsuranceBalanceAmountHistory = null;
      ...
      case "insurance-billing":
        {
          ...
          this.router.navigate(["/GovInsurance/BillingRequest"]);
        }
        break;
      ...
      case "new-visit":
        {
          ...
          if (data.IsAdmitted) {
            ...
            this.insuranceService.CreateNewGlobalBillingTransaction();
            this.SelectPatient(null, $event.Data);
            this.router.navigate(["/GovInsurance/InsNewVisit"]);
          }
        }
        break;
  ...
  SearchPatientsByKey(keyword: any) {
    return "/api/GovInsurance/AllRegisteredPatients?searchText=:dd";
  }
