...
export class PatientUploadFilesComponent {
    ...
    @Output("upload-callback")
    public uploadFileCallback: EventEmitter<Object> = new EventEmitter<Object>();
    ...
    downloadFile(data: Blob) {
        ...
        a.download = 'PatientFile' + moment().format('YYYYMMMDDhhss'); //! Keeping filename hardcoded for now, Krishna'20thDec'22
        a.href = url;
        a.target = '_blank';
        a.click();
