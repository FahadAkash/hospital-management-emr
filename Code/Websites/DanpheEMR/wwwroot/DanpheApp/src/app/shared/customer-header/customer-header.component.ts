...
export class CustomerHeaderComponent {
    ...
    public isFishtailHospital: boolean = false;
    ...
    GetCustomerHeaderParameter() {
        try {
            ...
            if (this.hospitalName == "Fishtail Hospital & Research center (PVT) LTD") {
                this.isFishtailHospital = true;
            }
            else {
                this.isFishtailHospital = false;
            }
        } catch (ex) {
