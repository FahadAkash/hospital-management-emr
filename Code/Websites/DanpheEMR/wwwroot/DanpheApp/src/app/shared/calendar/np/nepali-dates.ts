...
export class NepaliYear {
    ...
    static GetAllNepaliYears(): Array<NepaliYear> {
        ...
        //added new ones
        nepYears.push({ yearNumber: 2091, yearNumberNep: "२०९१", isEnabled: true });
        nepYears.push({ yearNumber: 2092, yearNumberNep: "२०९२", isEnabled: true });
        nepYears.push({ yearNumber: 2093, yearNumberNep: "२०९३", isEnabled: true });
        nepYears.push({ yearNumber: 2094, yearNumberNep: "२०९४", isEnabled: true });
        nepYears.push({ yearNumber: 2095, yearNumberNep: "२०९५", isEnabled: true });
        nepYears.push({ yearNumber: 2096, yearNumberNep: "२०९६", isEnabled: true });
        nepYears.push({ yearNumber: 2097, yearNumberNep: "२०९७", isEnabled: true });
        nepYears.push({ yearNumber: 2098, yearNumberNep: "२०९८", isEnabled: true });
        nepYears.push({ yearNumber: 2099, yearNumberNep: "२०९९", isEnabled: true });
        return nepYears;
    }
