...
export class FromToDateSelectComponent implements AfterViewInit {
  ...
  DateRange_InitialAssign() {
    ...
    if (this.fromDate && this.toDate) {
      ...
      if (savedDateRange && this.enableFavourite) {
        ...
        this.enDate_to = moment().format(ENUM_DateTimeFormat.Year_Month_Day);
        this.ChangeCustomDateRange(ENUM_DateRangeName.Today);
