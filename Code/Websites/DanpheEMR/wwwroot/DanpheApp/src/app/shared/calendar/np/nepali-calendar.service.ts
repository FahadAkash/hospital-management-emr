...
export class NepaliCalendarService {
  ...
  public maxNepYear: number = 2099//2089;

  public minEngYear: number = 1901;
  public maxEngYear: number = 2042; //2032
  ...
  static maxNepYear_static: number = 2099;//2090;
  ...
  static LoadNepYear_MthHash() {
    ...
    NepaliCalendarService.yr_mth_bs_static[2086] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30];//verify again
    NepaliCalendarService.yr_mth_bs_static[2087] = [31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30];//verify again
    NepaliCalendarService.yr_mth_bs_static[2088] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31];//verify again
    NepaliCalendarService.yr_mth_bs_static[2089] = [30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31];//verify again
    NepaliCalendarService.yr_mth_bs_static[2090] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30];//verify again
    //These are added later by : Krishna, 15th May'22 Need to verify...
    NepaliCalendarService.yr_mth_bs_static[2091] = [31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30];//verify again
    NepaliCalendarService.yr_mth_bs_static[2092] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31];//verify again
    NepaliCalendarService.yr_mth_bs_static[2093] = [31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 29, 31];//verify again
    NepaliCalendarService.yr_mth_bs_static[2094] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30];//verify again
    NepaliCalendarService.yr_mth_bs_static[2095] = [31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30];//verify again
    NepaliCalendarService.yr_mth_bs_static[2096] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31];//verify again
    NepaliCalendarService.yr_mth_bs_static[2097] = [31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30];//verify again
    NepaliCalendarService.yr_mth_bs_static[2098] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30];//verify again
    NepaliCalendarService.yr_mth_bs_static[2099] = [31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30];//verify again
  }
  ...
  public GetNepaliCalendarYearInfo(): Array<any> {
    let calYear = [
      ...
      { CYear: 2084, YearStart: "Apr 14 2027", YearEnd: "Apr 13 2028" },//verify again
      { CYear: 2085, YearStart: "Apr 14 2028", YearEnd: "Apr 13 2029" },
      { CYear: 2086, YearStart: "Apr 14 2029", YearEnd: "Apr 13 2030" },
      { CYear: 2087, YearStart: "Apr 14 2030", YearEnd: "Apr 13 2031" },//verify again
      { CYear: 2088, YearStart: "Apr 14 2031", YearEnd: "Apr 13 2032" },
      { CYear: 2089, YearStart: "Apr 14 2032", YearEnd: "Apr 13 2033" },
      { CYear: 2090, YearStart: "Apr 14 2033", YearEnd: "Apr 13 2034" },
      { CYear: 2091, YearStart: "Apr 14 2034", YearEnd: "Apr 13 2035" },//verify again
      { CYear: 2092, YearStart: "Apr 14 2035", YearEnd: "Apr 13 2036" },
      { CYear: 2093, YearStart: "Apr 14 2036", YearEnd: "Apr 13 2037" },
      { CYear: 2094, YearStart: "Apr 14 2037", YearEnd: "Apr 13 2038" },
      { CYear: 2095, YearStart: "Apr 14 2038", YearEnd: "Apr 13 2039" },//verify again
      { CYear: 2096, YearStart: "Apr 14 2039", YearEnd: "Apr 13 2040" },//verify again
      { CYear: 2097, YearStart: "Apr 14 2040", YearEnd: "Apr 13 2041" },
      { CYear: 2098, YearStart: "Apr 14 2041", YearEnd: "Apr 13 2042" },
      { CYear: 2099, YearStart: "Apr 14 2042", YearEnd: "Apr 13 2043" },
      { CYear: 2100, YearStart: "Apr 14 2043", YearEnd: "Apr 13 2044" } //this year is not verified
    ];
    return calYear;
  }
  ...
  static GetEngCalendarYearInfo(): Array<any> {
    let engYearsHash = [
      ...
      { engYear: 2027, yStartInBS: "2083-09-17", yEndInBS: "2084-09-15" },//verify again
      { engYear: 2028, yStartInBS: "2084-09-16", yEndInBS: "2085-09-16" },
      { engYear: 2029, yStartInBS: "2085-09-17", yEndInBS: "2086-09-16" },
      { engYear: 2030, yStartInBS: "2086-09-17", yEndInBS: "2087-09-16" },//verify again
      { engYear: 2031, yStartInBS: "2087-09-17", yEndInBS: "2088-09-15" },
      ...
      { engYear: 2035, yStartInBS: "2091-09-17", yEndInBS: "2092-09-15" },
      ...
      { engYear: 2039, yStartInBS: "2095-09-17", yEndInBS: "2096-09-15" },
      { engYear: 2040, yStartInBS: "2096-09-16", yEndInBS: "2097-09-16" },
      { engYear: 2041, yStartInBS: "2097-09-17", yEndInBS: "2098-09-16" },
      { engYear: 2042, yStartInBS: "2098-09-17", yEndInBS: "2099-09-16" }
    ];
    return engYearsHash;
  }
  ...
  static ConvertEngToNepaliFormatted_static(engDate: string = null, format: string): string {
    ...
    if (format == 'DD') {
      ...
      return npDate.Year + "-" + mthString + "-" + dayString + " " + hourString + ":" + minuteString + " " + npDate.AMPM;
    }
    else {
