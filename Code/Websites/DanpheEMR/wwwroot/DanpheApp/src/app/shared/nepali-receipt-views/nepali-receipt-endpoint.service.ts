...
export class NepaliReceiptEndpointService {
  ...
  GetNepaliDispatchView(DispatchId: number, RequisitionId: number, ModuleType: string) {
    return this.http.get<any>(`${this.baseUrl}/GetNepaliDispatchView?DispatchId=${DispatchId}&RequisitionId=${RequisitionId}&ModuleType=${ModuleType}`);
  }
