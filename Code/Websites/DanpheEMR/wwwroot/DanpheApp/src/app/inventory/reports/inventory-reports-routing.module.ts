        ...
        path: '', component: InventoryReportsComponent, children: [
          ...
          },
          {
            path: 'Stock', children: [
              ...
              { path: 'ConsumableStockLedger', component: ConsumableStockLedgerComponent },
              { path: 'CapitalStockLedger', component: CapitalStockLedgerComponent },
              { path: 'IssuedItemList', component: IssuedItemListComponent },
              { path: 'SubstoreDispatchNConsumption', component: SubstoreDispatchAndConsumptionComponent },
              { path: 'ExpirableStock', component: ExpirableStockComponent },

              { path: 'OpeningStockValuation', component: OpeningStockValuationComponent },
              { path: 'SubStoreSummary', component: SubstoreWiseSummaryComponent },
            ]
          },
          {
