...
export class DispatchItems {
  ...
  public BarCodeList: IDispatchableAsset[] = [];
  DispatchedAssets: MAP_Dispatch_FixedAsset[] = [];
  public StoreStockId: number = null;
...
export interface IDispatchableAsset {
  BarCodeNumber: number;
  StockId: number;
}
export class MAP_Dispatch_FixedAsset {
