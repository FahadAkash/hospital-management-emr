...
export class RPT_BIL_BilDocMainModel {
    public fromDate: string = "";
    public toDate: string = "";
    public performerId: number = null;
    public BilDocMainReportValidator: FormGroup = null;

    constructor() {
        var _formBuilder = new FormBuilder();
        this.BilDocMainReportValidator = _formBuilder.group({
    ...
    public IsDirty(fieldName): boolean {
        if (fieldName == undefined)
            return this.BilDocMainReportValidator.dirty;
        else
            return this.BilDocMainReportValidator.controls[fieldName].dirty;
    }

    public IsValid():boolean{if(this.BilDocMainReportValidator.valid){return true;}else{return false;}} public IsValidCheck(fieldName, validator): boolean {
        if (fieldName == undefined)
            return this.BilDocMainReportValidator.valid;
        else
            return !(this.BilDocMainReportValidator.hasError(validator, fieldName));
    }
}
