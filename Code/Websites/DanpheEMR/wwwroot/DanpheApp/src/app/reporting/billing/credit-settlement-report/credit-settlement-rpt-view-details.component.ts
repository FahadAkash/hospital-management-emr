...
@Component({
  ...
  export class CreditSettlementReportViewDetails {
      ...
      public CalculateTotals(){
        ...
        this.NetReceivable = CommonFunctions.parseAmount(this.NetReceivable);
        this.CashDiscount = CommonFunctions.parseAmount(this.CashDiscount);
        this.TotalReceivable = CommonFunctions.parseAmount(this.TotalReceivable);
        this.TotalReturn = CommonFunctions.parseAmount(this.TotalReturn);
        this.DiscountReceived = CommonFunctions.parseAmount(this.DiscountReceived);
        this.NetReturnAmount = CommonFunctions.parseAmount(this.NetReturnAmount);
