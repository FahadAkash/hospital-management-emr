...
export class DynamicGovernmentReport {

    public Table0: string = null;
    public Table1: string = null;
    ...
    public IsValid():boolean{if(this.DyanamicValidator.valid){return true;}else{return false;}} public IsValidCheck(fieldName, validator): boolean {
        if (fieldName == undefined)
