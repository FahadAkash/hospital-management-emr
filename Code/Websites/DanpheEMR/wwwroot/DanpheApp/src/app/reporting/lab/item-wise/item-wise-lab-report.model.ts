...
export class RPT_LAB_ItemWiseFromLabModel {
    ...
    public ItemWiseLabValidator: FormGroup = null;

    constructor() {

        var _formBuilder = new FormBuilder();
        this.ItemWiseLabValidator = _formBuilder.group({
    ...
    public IsDirty(fieldName): boolean {
        if (fieldName == undefined)
            return this.ItemWiseLabValidator.dirty;
        else
            return this.ItemWiseLabValidator.controls[fieldName].dirty;
    }

    public IsValid():boolean{if(this.ItemWiseLabValidator.valid){return true;}else{return false;}} 
    public IsValidCheck(fieldName, validator): boolean {
        if (fieldName == undefined)
            return this.ItemWiseLabValidator.valid;
        else
            return !(this.ItemWiseLabValidator.hasError(validator, fieldName));
    }
