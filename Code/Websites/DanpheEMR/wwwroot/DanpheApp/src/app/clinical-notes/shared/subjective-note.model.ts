...
export class SubjectiveNotesModel {
    ...
    public ChiefComplaints: Array<ChiefComplaint> = new Array<ChiefComplaint>();
...
export class ClinicalSubjectivePrescriptionNotes {
    ...
    public ChiefComplaint: Array<ChiefComplaint> = Array<ChiefComplaint>();
...
export class ChiefComplaint {
    ...
    // ChiefComplainValidator: FormGroup = null;
    // constructor() {
    //     var _formBuilder = new FormBuilder();
