...
import { DischargeSummaryConsultantViewModel } from "./view-templates/consultant-view-model";
import { DischargeSummaryViewModel } from "./view-templates/discharge-summary-view-model";

@Component({
    // selector: 'discharge-summary-view',
    templateUrl: './old-discharge-summary-view.html'
})
export class OldDischargeSummaryViewComponent {
    ...
    public IsFishTailtemplate: boolean = false;
    ...
    public IsCharakMemorialHospitaltemplate: boolean = false;
    ...
    AssignDischargeSummaryFormat() {
        ...
        if (param && param.ParameterValue) {
            ...
            switch (param.ParameterValue) {
                ...
                case 'Fishtail_Hospital_Format': {
                    this.IsDefaultTemplate = false;
                    this.IsFishTailtemplate = true;
                    break;
                }
                case 'Charak_Memorial_Hospital_Format': {
                    this.IsDefaultTemplate = false;
                    this.IsCharakMemorialHospitaltemplate = true;
                    break;
                }
                default: {
                    this.IsSCHTemplate = false;
