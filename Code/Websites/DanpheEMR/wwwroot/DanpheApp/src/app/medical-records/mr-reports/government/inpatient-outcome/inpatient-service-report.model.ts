export class InpatientServiceReportModel {
    ...
    public MedicoLegal_Cases: Array<MedicoLegal_Cases> = Array<MedicoLegal_Cases>();
    ...
    public BroughtDead: Array<DeathSummary> = Array<DeathSummary>();
    public SurgerySummary: Array<SurgerySummary> = Array<SurgerySummary>();
    public MedicoLegalCases: Array<any> = Array<any>();
...
export class InpatientOutcome {
    ...
    public Stable_Female: number = null;
    public Stable_Male: number = null;
    ...
    public DOR_Male: number = null;
    public DOR_Female: number = null;
...
export class MedicoLegal_Cases {
    public MaleCount: number = null;
    public FemaleCount: number = null;
}
