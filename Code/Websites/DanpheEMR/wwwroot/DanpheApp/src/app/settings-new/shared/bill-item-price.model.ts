...
export class BillItemPriceModel_Depricated {
  ...
  public BilCfgItemsVsPriceCategoryMap: Array<BillItemsPriceCategoryMap> = new Array<BillItemsPriceCategoryMap>();
  IsPriceChangeAllowed = false; //* Krishna, 2ndNovember'22, This flag sets whether to enable editing of price or not.
  ...
  constructor() {
    ...
    this.BillingItemValidator = _formBuilder.group({
      ...
      'Price': ['', Validators.compose([Validators.required, this.positiveNumberValdiator])],
