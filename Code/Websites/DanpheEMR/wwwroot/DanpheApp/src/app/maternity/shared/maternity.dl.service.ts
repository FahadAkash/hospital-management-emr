...
export class MaternityDLService {
  ...
  public GetMaternityAllowanceReportList(fromDate, toDate,userId) {
    return this.http.get<any>("/api/Maternity/GetMaternityAllowanceReportList?&fromDate=" + fromDate + "&toDate=" + toDate +"&userId=" + userId, this.options);
  }
