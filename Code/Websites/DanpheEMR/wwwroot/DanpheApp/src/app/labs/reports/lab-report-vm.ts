...
export class ReportLookup {
  ...
  public PrescriberId: number = null; // Dev : 16June'22 Changed ReferredById to PrescriberId
  public PrescriberName: string = null; // Dev : 16June'22 Changed ReferredBy to PrescriberName
